	    ...
	    <div class="row">
	        ...
	        <div class="col-9 align-self-center">
	            ...
	            <div class="form-group width230 float-left">
	               <span> From</span><input type="text" class="date form-control" name="start_date" placeholder="Start Date" autocomplete="off" value="{{ isset($params['start_date']) && !empty($params['start_date']) ? date('d M Y', strtotime($params['start_date'])) : '' }}">
	            </div>
	            ...
	            <div class="customize-input float-right">
	             ...
	             <div class="customize-input float-right"><input type="submit" name="" class="btn btn-primary filter-btn" value="Filter"></div>
	        </form>
