            ...
            <div class="col-10 offset-md-1 form_v">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('save-product') }}" method="POST" id="Login" enctype="multipart/form-data">
                            <div class="form-body">
                                <div class="row">
                                    @csrf
                                    ...
                                    <div class="col-lg-12 col-md-12 floating-label-wrap">
                                        <input name="bar_code" type="text" class="floating-label-field floating-label-field--s1 name" id="inputName" placeholder="Bar Code*" value="{{ old('bar_code') }}" required>
                                        <label for="inputName" class="floating-label">Bar Code*</label>
                                    </div>
                                    <div class="col-lg-12 col-md-12 floating-label-wrap">
                                        <input name="price" type="text" class="floating-label-field floating-label-field--s1 name decimal_format" id="inputPrice" placeholder="Price*" value="{{ old('price') }}" required>
                                        <label for="inputPrice" class="floating-label">Price*</label>
                                    </div>
                                    <div class="col-lg-12 col-md-12 floating-label-wrap">
                                        <textarea class="floating-label-field floating-label-field--s1 name" name="description" id="inputStoreAddress" rows="3" placeholder="Description">{{ old('description') }}</textarea>
                                        <label for="inputStoreAddress" class="floating-label">Description</label>
                                    </div>
                                    <div class="col-lg-12 col-md-12 floating-label-wrap">
                                        <label for="categories">Category*</label>
                                        <select class="form-control mb-3 categories" name="category_id" id="categories" required>
