                    ...
                    <form action="{{ route('update-customer-details') }}" method="POST" id="Login" enctype="multipart/form-data">
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 floating-label-wrap">
                                    <input type="number"  min="0" name="phone_number" placeholder="CELULAR*" class="floating-label-field floating-label-field--s1 phone_number" value="{{ $customer->phone_number }}" required pattern="[0-9]{10}" onkeypress="limitKeypress(event, this.value, 10)" onkeydown="return event.keyCode !== 69">
                                   <!--  <input type="number" min="0" name="phone_number" id="phone" class="form-control my-input phone_number" placeholder="Numero Celular" pattern="[0-9]{10}" onkeypress="limitKeypress(event, this.value, 10)" required value=""onkeydown="return event.keyCode !== 69 && event.keyCode !== 187 && event.keyCode !== 189"> -->
