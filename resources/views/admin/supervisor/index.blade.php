				...
				<div class="card">
				    <div class="card-body">
						...
						<div class="table-responsive">
							<table id="supervisors"  class="table no-wrap v-middle mb-0 dashboard-table responsive nowrap">
								<thead>
									<tr class="border-0">
									...
									<tr>
										...
										<td class="border-top-0 text-muted px-2 py-4 font-14">
										 ...
										 <td class="border-top-0 px-2 py-4">
												...
												<a href="javascript:void(0);" data-url="{{ route('delete-supervisor', ['id' => $user->id])  }}" class="change-psd-btn px-2 delete_supervisor" title="Delete Supervisor"><i class="fas fa-trash"></i></a>
												<a href="{{ route('supervisor-change-password', ['id' => $user->id])  }}" class="change-psd-btn" title="Change Password"><i class="fas fa-unlock-alt"></i></a> 
											</td>
									</tr>
									@endforeach 
								</tbody>
